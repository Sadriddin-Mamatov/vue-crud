<template>
	<router-view v-slot="{ Component }">
		<div class="h-screen flex overflow-hidden z-50">
			<div class="flex flex-shrink-0">
				...
				>
					<a href="/" class="flex items-center">
						<svg class="w-auto h-7" viewBox="0 0 128 128" width="24" height="24" data-v-11b02119="">
						...
						<span class="mx-2 text-sm font-medium">Sadriddin</span>
					</a>
					...
					<div class="flex flex-col justify-between flex-1 mt-6">
						<nav class="flex-1 -mx-3 space-y-3">
							...
							<div class="flex items-center justify-between mt-6">
								<a to="/" class="flex items-center gap-x-2">
									<img
										...
										alt="avatar"
									/>
									<span class="text-sm font-medium text-gray-700 dark:text-gray-200">Sadriddin</span>
								</a>
			...
			<div class="flex flex-col w-0 flex-1 overflow-hidden">
				<div class="at-sidebar px-4 sm:px-6 py-6 overflow-auto h-screen dark:bg-gray-900 dark:text-white">
